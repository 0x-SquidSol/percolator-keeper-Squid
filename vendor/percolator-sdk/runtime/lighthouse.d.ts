 ...
 * ```
 */
export declare function stripLighthouseInstructions(instructions: TransactionInstruction[]): TransactionInstruction[];
/**
 ...
 * ```
 */
export declare function stripLighthouseFromTransaction(transaction: Transaction): Transaction;
/**
